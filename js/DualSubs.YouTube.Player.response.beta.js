...
const $ = new Env("🍿 DualSubs for ▶ YouTube v0.6.6(6) player.response.beta");
const URL = new URLs();
const DataBase = {
	"Verify": {
		...
		default:
			...
			switch (Format) {
				...
				case "application/x-protobuf":
					...
					const Player_StreamingData_AdaptiveFormats_ColorInfo = new Player_StreamingData_AdaptiveFormats_ColorInfo$Type();
