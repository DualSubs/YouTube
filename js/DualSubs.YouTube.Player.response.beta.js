		...
		default:
			...
			switch (Format) {
				...
				case "application/x-protobuf":
					...
					const Player_StreamingData = new Player_StreamingData$Type();
					...
					const Player_StreamingData_AdaptiveFormats = new Player_StreamingData_AdaptiveFormats$Type();
					...
					const Player_StreamingData_AdaptiveFormats_AudioTrack = new Player_StreamingData_AdaptiveFormats_AudioTrack$Type();
					...
					const Player_StreamingData_AdaptiveFormats_CaptionTrack = new Player_StreamingData_AdaptiveFormats_CaptionTrack$Type();
					...
					let UF = UnknownFieldHandler.list(data?.streamingData?.adaptiveFormats[data?.streamingData?.adaptiveFormats?.length - 2]);
